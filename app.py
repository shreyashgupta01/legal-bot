...
def stream_response(user_input, token):
    ...
    try:
        ...
        socketio.emit('error_message', {'message': f'Error generating legal response: {str(e)}'})
    finally:
        if token == current_token:
...
def test_tts():
    ...
    text_to_speech("This is a test of the legal assistant text to speech system.")
...
<body>
    ...
    print("Starting Legal Assistant Web App...")
